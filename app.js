...
// Sidenote for future-self: querySelector more versatile, getElementById faster
let productLoc = ['bag.jpg','banana.jpg','bathroom.jpg','boots.jpg','breakfast.jpg','bubblegum.jpg','chair.jpg','cthulhu.jpg','dog-duck.jpg','dragon.jpg','pen.jpg','pet-sweep.jpg','scissors.jpg','shark.jpg','sweep.jpg','tauntaun.jpg','unicorn.jpg','water-can.jpg','wine-glass.jpg'];
let products = [];
...
let imagesSection = document.querySelector('#listedProducts');
...
for (let i = 0; i < productLoc.length; i++) {
  new Product(productLoc[i]);
}
randomImage();
numberRounds++;
...
function clicks(e) {
  ...
  rounds.textContent = ('This is vote number ' + numberRounds);
  if (totalClicks === 25) {
